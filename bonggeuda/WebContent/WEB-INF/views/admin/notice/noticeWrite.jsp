			...
			<div class="blog-list">
                ...
                <table class="type09" border="1px">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">제목</th>
                            <td colspan="3" style="width: 650px;" ><input style="width: 650px; height: 20px; border: 0; resize: none;" name="title"></input></td>
                        </tr>
                        <tr>
                            <th scope="row">구분</th>
				...
				<p>
				<textarea class="form-control textarea-layer" style="width: 700px; height: 400px; margin-left: 285px; resize: none;" name="content">공지사항 적기</textarea>
				</p>
                <br>
                <table class="type09">
                    <thead>
                ...
                <button class="submit-btn" type="submit" style="margin-top: 10px; margin-bottom: 10px;">공지사항 등록</button>
            </div>
        </div>
        </form>
        <br><br><br><br><br>
