...
<!--blog-->
		...
		<div class="container">
			<div class="blog-list">
				...
				<table class="table table-hover" style="width: 800px;">
			        ...
			        <form action="${ pageContext.servletContext.contextPath }/report/detail" method="get">
			          <tr>
							<td><c:out value="${report.rnum}"/></td>
							<td><c:out value="${report.title}"/></td>
							<td><c:out value="${report.reportDate}"/></td>
							<td><c:out value="${report.wirterType}"/></td>
	...
	<div class="clearfix"> </div>
		...
		<!-- 검색 폼 -->
		<form id="loginForm" action="${ pageContext.servletContext.contextPath }/report/writerSearch" method="get">		
		...
		const searchLink = "${ pageContext.servletContext.contextPath }/report/writerSearch";
