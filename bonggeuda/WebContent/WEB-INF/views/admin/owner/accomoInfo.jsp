				...
				<center>
					...
					<div class="detailList" > 
						...
						<div class="detailInfo" >
							...
							<hr>
							<div>
								<button class="detail_btn">숙소정보 확인 페이지 입니다.</button>
							</div>
						</div>
					</div>
					</c:forEach>
...
<!--//footer-->
<div>
<button align="center" onclick="location.href='${pageContext.servletContext.contextPath}/owner/list'"><h1>확인</h1></button>
</div>
