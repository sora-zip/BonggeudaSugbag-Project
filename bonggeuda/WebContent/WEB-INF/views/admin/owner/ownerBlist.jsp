				...
				<nav>
					<div class="col-md-3 blog-sidebar">
						<ul>
							...
							<li class="blog-list" id="ownerList"><a>
							업체 정보 확인</a></li>
							<li class="blog-list" id="bList"><a style="color: #6eceda; font-size: 1.3em; font-weight: 600;">블랙리스트 업체</a></li>
						</ul>
				</nav>
				<table class="table" style="width: 800px;">
					<div class="tab">
						<span class="tab_btn active" data-toggle="tab">블랙 리스트 업체</span>
					</div>
					<thead>
						<tr>
							<th>블랙리스트 번호</th>
					...
					<tbody>
						<c:choose>
							<c:when test="${ empty requestScope.searchBlist}">

								<c:forEach var="bMember" items="${requestScope.bList }">
									<tr>
										<td><c:out value="${bMember.rowNum }"></c:out></td>
										<td><c:out value="${bMember.memberNo }"></c:out></td>
										<td><c:out value="${bMember.bReason }"></c:out></td>
										<td><c:out value="${bMember.enrollDate }"></c:out></td>
									</tr>
								</c:forEach>
