	...
	<div class="blog">
		<div class="container">
			<div class="blog-list">
				...
				<ul>
					<li class="blog-list"><a href="${ pageContext.servletContext.contextPath }/qna/list" style="color: #6eceda; font-size: 1.3em; font-weight: 600;" >문의 내역</a></li>
                    <li class="blog-list"><a href="${ pageContext.servletContext.contextPath }/report/list">신고 내역</a></li>
				</ul>
				</nav>
